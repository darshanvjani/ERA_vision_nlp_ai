...
class MultiheadSelfAttentionBlock(nn.Module):
    def __init__(self, embed_dim: int, num_heads: int, attn_dropout: float) -> None:
        """
...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            add_cls_token: Whether to add a CLS token to the input
            pe_requires_grad: Whether to make the positional embeddings trainable
            need_embedding: Whether to add an embedding layer
