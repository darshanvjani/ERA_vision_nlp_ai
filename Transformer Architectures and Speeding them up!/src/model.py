...
class Transformer(LightningModule):
    ...
    def on_validation_epoch_end(self):
        ...
        print(
            f"EPOCH: {self.current_epoch}, CER: {self.trainer.callback_metrics['Validation CER']}, WER: {self.trainer.callback_metrics['Validation WER']}, BLEU: {self.trainer.callback_metrics['Validation BLEU']}"
        )
...
def build_transformer(
    ...
    #Parameter sharing paper 2022 replicated for faster convergence https://arxiv.org/pdf/2104.06022.pdf
    ...
    encoder = Encoder(d_model, nn.ModuleList(encoder_blocks1))
    decoder = Decoder(d_model, nn.ModuleList(decoder_blocks1))
